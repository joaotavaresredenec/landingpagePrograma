...
export default async function MaterialPage({
  ...
  // Exige sessão — sem cookie vai para o login da biblioteca
      ...
      <div className="container-site section-spacing">
        ...
        <nav aria-label="Navegação estrutural" className="mb-8">
          <ol className="flex items-center gap-1 text-[13px] text-gray-500 flex-wrap">
            <li>
              <Link href="/biblioteca" className="hover:text-redenec-petroleo transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-redenec-verde rounded">
