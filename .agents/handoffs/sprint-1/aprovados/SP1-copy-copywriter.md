...
Pendência aberta (não bloqueante para Sprint 2): `copySobre.texto` menciona "mais de 1.200 municípios e estados já aderidos" — dado a confirmar com a Redenec antes do deploy.
